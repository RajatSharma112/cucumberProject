...
public class JobBoard {
    ...
    public void createANewUser() throws Throwable {
    	...
    	driver.findElement(By.id("user_login")).sendKeys("Krishna0303");
    	driver.findElement(By.id("email")).sendKeys("testdas@gmail.com");
    	driver.findElement(By.id("first_name")).sendKeys("Krishna");
    ...
    public void validateUserCreation() throws Throwable {
    	...
    	driver.findElement(By.id("user-search-input")).sendKeys("Krishna0303");
    	driver.findElement(By.id("search-submit")).click();
    	WebElement userName = driver.findElement(By.cssSelector(".username > strong:nth-child(2) > a:nth-child(1)"));
    	Assert.assertEquals(userName.getText(), "Krishna0303");
    } 
